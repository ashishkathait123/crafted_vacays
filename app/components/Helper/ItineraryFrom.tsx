...
const ItineraryForm = ({ onClose }) => {
  ...
  const handleSubmit = () => {
    ...
    const message = `📌 New Destination Inquiry:
...
- Persons: ${persons}`;
  ...
  const renderForm = () => (
    ...
    >
      ...
      <motion.h2
        className="text-lg italic font-semibold text-gray-700"
      ...
      <motion.div className="mt-5 flex items-center gap-3 border p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-300" whileHover={{ scale: 1.02 }}>
        ...
        <div className="flex flex-col w-full">
          ...
          <input type="text" value={destination} onChange={(e) => setDestination(e.target.value)} placeholder="e.g. Maldives, Bali" className="mt-1 border rounded px-2 py-1 text-gray-700 bg-white outline-orange-500" />
        </div>
      </motion.div>
      ...
      <motion.div className="mt-4 flex items-center gap-3 border p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-300" whileHover={{ scale: 1.02 }}>
        ...
        <div className="flex flex-col w-full">
          ...
          <select value={travelMonth} onChange={(e) => setTravelMonth(e.target.value)} className="mt-1 border rounded px-2 py-1 text-gray-700 bg-white outline-orange-500">
            {months.map((month) => (
      ...
      <motion.div className="mt-4 flex items-center gap-3 border p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-300" whileHover={{ scale: 1.02 }}>
        ...
        <div className="flex flex-col w-full">
          ...
          <select value={duration} onChange={(e) => setDuration(e.target.value)} className="mt-1 border rounded px-2 py-1 text-gray-700 bg-white outline-orange-500">
      ...
      <motion.div className="mt-4 flex items-center gap-3 border p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-300" whileHover={{ scale: 1.02 }}>
        ...
        <div className="flex flex-col w-full">
          ...
          <select value={persons} onChange={(e) => setPersons(e.target.value)} className="mt-1 border rounded px-2 py-1 text-gray-700 bg-white outline-orange-500">
